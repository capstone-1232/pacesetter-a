...
<div class="rentals-info">
    ...
    <p>An imprint of a valid Visa or MasterCard credit card for all rental reservations as a security deposit.(American Express cannot be used for pre-authorization).</p>
    <ul>
        <li>300 for Basic Ski rentals & Snowboard rentals</li>
        <li>$500.00 for Demo rentals</li>
    </ul>
    <p>The credit card holder must be present to sign the imprint.</p>
